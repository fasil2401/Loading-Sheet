...
class CreateLoadingSheetScreen extends StatelessWidget {
                              ...
                              children: [
                                Expanded(
                                  child: _buildTileTextTime(
                                      text: " 9.00 am", title: 'StartTime'),
                                ),
                                Expanded(
                                  child: _buildTileTextTime(
                                      text: " 6.00 pm", title: 'EndTime'),
                                ),
                              ],
                            ),
                            const SizedBox(
  ...
  Row _buildTileTextAlert({required String title1, required String title2,required String title3,}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Row popupTitle({required Function() onTap,}) {
    return Row(
                      ...
                      Container(
                        ...
                        Row(
                          children: [
                            ...
                            Text("(90)", style: TextStyle(fontSize: 20,color: Color(0xff01579b),)),
                          ],
                        ),
                      ),
                      Container(
